  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'glow-orange': '0 0 16px rgba(255, 165, 0, 0.2)',
        'glow-orange-hover': '0 0 24px rgba(255, 165, 0, 0.4), 0 0 48px rgba(255, 165, 0, 0.2)',
        'glow-pink': '0 0 16px rgba(255, 20, 147, 0.2)',
        'glow-pink-hover': '0 0 24px rgba(255, 20, 147, 0.4), 0 0 48px rgba(255, 20, 147, 0.2)',
        'glow-indigo': '0 0 16px rgba(75, 0, 130, 0.2)',
        'glow-indigo-hover': '0 0 24px rgba(75, 0, 130, 0.4), 0 0 48px rgba(75, 0, 130, 0.2)',
        'glow-teal': '0 0 16px rgba(0, 128, 128, 0.2)',
        'glow-teal-hover': '0 0 24px rgba(0, 128, 128, 0.4), 0 0 48px rgba(0, 128, 128, 0.2)',
        'glow-yellow': '0 0 16px rgba(255, 255, 0, 0.2)',
        'glow-yellow-hover': '0 0 24px rgba(255, 255, 0, 0.4), 0 0 48px rgba(255, 255, 0, 0.2)',
        'glow-red': '0 0 16px rgba(255, 0, 0, 0.2)',
        'glow-red-hover': '0 0 24px rgba(255, 0, 0, 0.4), 0 0 48px rgba(255, 0, 0, 0.2)',
      },
      animation: {
